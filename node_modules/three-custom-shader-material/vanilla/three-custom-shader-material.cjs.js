"use strict";const D=require("three");function H(l){const s=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(l){for(const o in l)if(o!=="default"){const f=Object.getOwnPropertyDescriptor(l,o);Object.defineProperty(s,o,f.get?f:{enumerable:!0,get:()=>l[o]})}}return s.default=l,Object.freeze(s)}const C=H(D),b=`
...
`,e={diffuse:"csm_DiffuseColor",roughness:"csm_Roughness",metalness:"csm_Metalness",emissive:"csm_Emissive",ao:"csm_AO",bump:"csm_Bump",fragNormal:"csm_FragNormal",clearcoat:"csm_Clearcoat",clearcoatRoughness:"csm_ClearcoatRoughness",clearcoatNormal:"csm_ClearcoatNormal",transmission:"csm_Transmission",thickness:"csm_Thickness",iridescence:"csm_Iridescence",pointSize:"csm_PointSize",fragColor:"csm_FragColor",depthAlpha:"csm_DepthAlpha",unlitFac:"csm_UnlitFac",position:"csm_Position",positionRaw:"csm_PositionRaw",normal:"csm_Normal"},k={[`${e.position}`]:"*",[`${e.positionRaw}`]:"*",[`${e.normal}`]:"*",[`${e.depthAlpha}`]:"*",[`${e.pointSize}`]:["PointsMaterial"],[`${e.diffuse}`]:"*",[`${e.fragColor}`]:"*",[`${e.fragNormal}`]:"*",[`${e.unlitFac}`]:"*",[`${e.emissive}`]:["MeshStandardMaterial","MeshPhysicalMaterial"],[`${e.roughness}`]:["MeshStandardMaterial","MeshPhysicalMaterial"],[`${e.metalness}`]:["MeshStandardMaterial","MeshPhysicalMaterial"],[`${e.iridescence}`]:["MeshStandardMaterial","MeshPhysicalMaterial"],[`${e.ao}`]:["MeshStandardMaterial","MeshPhysicalMaterial","MeshBasicMaterial","MeshLambertMaterial","MeshPhongMaterial","MeshToonMaterial"],[`${e.bump}`]:["MeshLambertMaterial","MeshMatcapMaterial","MeshNormalMaterial","MeshPhongMaterial","MeshPhysicalMaterial","MeshStandardMaterial","MeshToonMaterial","ShadowMaterial"],[`${e.clearcoat}`]:["MeshPhysicalMaterial"],[`${e.clearcoatRoughness}`]:["MeshPhysicalMaterial"],[`${e.clearcoatNormal}`]:["MeshPhysicalMaterial"],[`${e.transmission}`]:["MeshPhysicalMaterial"],[`${e.thickness}`]:["MeshPhysicalMaterial"]},w={"*":{"#include <lights_physical_fragment>":C.ShaderChunk.lights_physical_fragment,"#include <transmission_fragment>":C.ShaderChunk.transmission_fragment},[`${e.normal}`]:{"#include <beginnormal_vertex>":`
  ...
  `},[`${e.emissive}`]:{"vec3 totalEmissiveRadiance = emissive;":`
    ...
    `}},U={clearcoat:[e.clearcoat,e.clearcoatNormal,e.clearcoatRoughness],transmission:[e.transmission],iridescence:[e.iridescence]};function z(l){let s=0;for(let _=0;_<l.length;_++)s=l.charCodeAt(_)+(s<<6)+(s<<16)-s;const o=s>>>0;return String(o)}function B(l){try{new l}catch(s){if(s.message.indexOf("is not a constructor")>=0)return!1}return!0}function P(l){return l.replace(/\/\*[\s\S]*?\*\/|\/\/.*/g,"")}class V extends C.Material{constructor({baseMaterial:s,vertexShader:o,fragmentShader:f,uniforms:_,patchMap:I,cacheKey:S,...M}){if(!s)throw new Error("CustomShaderMaterial: baseMaterial is required.");let i;if(B(s)){const t=Object.keys(M).length===0;i=new s(t?void 0:M)}else i=s,Object.assign(i,M);if(["ShaderMaterial","RawShaderMaterial"].includes(i.type))throw new Error(`CustomShaderMaterial does not support ${i.type} as a base material.`);super(),this.uniforms={},this.vertexShader="",this.fragmentShader="";const n=i;n.name=`CustomShaderMaterial<${i.name||i.type}>`,n.update=this.update.bind(n),n.__csm={prevOnBeforeCompile:i.onBeforeCompile,baseMaterial:i,vertexShader:o,fragmentShader:f,uniforms:_,patchMap:I,cacheKey:S};const r={...n.uniforms||{},..._||{}};n.uniforms=this.uniforms=r,n.vertexShader=this.vertexShader=o||"",n.fragmentShader=this.fragmentShader=f||"",n.update({fragmentShader:n.fragmentShader,vertexShader:n.vertexShader,uniforms:n.uniforms,patchMap:I,cacheKey:S}),Object.assign(this,n);const u=Object.getOwnPropertyDescriptors(Object.getPrototypeOf(n));for(const t in u){const d=u[t];(d.get||d.set)&&Object.defineProperty(this,t,d)}return Object.defineProperty(this,"type",{get(){return i.type},set(t){i.type=t}}),this}update({fragmentShader:s,vertexShader:o,uniforms:f,cacheKey:_,patchMap:I}){const S=P(o||""),M=P(s||""),i=this;f&&(i.uniforms=f),o&&(i.vertexShader=o),s&&(i.fragmentShader=s),Object.entries(U).forEach(([a,r])=>{for(const u in r){const t=r[u];(M&&M.includes(t)||S&&S.includes(t))&&(i[a]||(i[a]=1))}});const R=i.__csm.prevOnBeforeCompile,n=(a,r,u)=>{let t,d="";if(r){const c=r.search(/void\s+main\s*\(\s*\)\s*{/);if(c!==-1){d=r.slice(0,c);let m=0,p=-1;for(let h=c;h<r.length;h++)if(r[h]==="{"&&m++,r[h]==="}"&&(m--,m===0)){p=h;break}if(p!==-1){const h=r.slice(c,p+1);t=h.slice(h.indexOf("{")+1,-1)}}else d=r}if(u&&(r&&r.includes(e.fragColor))&&t&&(t=`csm_UnlitFac = 1.0;
`+t),a.includes("//~CSM_DEFAULTS")){a=a.replace("void main() {",`
          ...
          void main() {
            ...
            ${t?`${t}`:""}
            //~CSM_MAIN_END
          `)}return a};i.onBeforeCompile=(a,r)=>{R==null||R(a,r);const u=I||{},t=i.type,d=t?`#define IS_${t.toUpperCase()};
`:`#define IS_UNKNOWN;
`;a.vertexShader=d+`#define IS_VERTEX
`+a.vertexShader,a.fragmentShader=d+`#define IS_FRAGMENT
`+a.fragmentShader;const v=c=>{for(const m in c){const p=m==="*"||S&&S.includes(m);if(m==="*"||M&&M.includes(m)||p){const g=k[m];if(g&&g!=="*"&&(Array.isArray(g)?!g.includes(t):g!==t)){console.error(`CustomShaderMaterial: ${m} is not available in ${t}. Shader cannot compile.`);return}const $=c[m];for(const E in $){const A=$[E];if(typeof A=="object"){const N=A.type,L=A.value;N==="fs"?a.fragmentShader=a.fragmentShader.replace(E,L):N==="vs"&&(a.vertexShader=a.vertexShader.replace(E,L))}else A&&(a.vertexShader=a.vertexShader.replace(E,A),a.fragmentShader=a.fragmentShader.replace(E,A))}}}};v(w),v(u),a.vertexShader=n(a.vertexShader,S,!1),a.fragmentShader=n(a.fragmentShader,M,!0),f&&(a.uniforms={...a.uniforms,...i.uniforms}),i.uniforms=a.uniforms};const T=i.customProgramCacheKey;i.customProgramCacheKey=()=>((_==null?void 0:_())||z((S||"")+(M||"")))+(T==null?void 0:T.call(i)),i.needsUpdate=!0}clone(){const s=this;return new s.constructor({baseMaterial:s.__csm.baseMaterial.clone(),vertexShader:s.__csm.vertexShader,fragmentShader:s.__csm.fragmentShader,uniforms:s.__csm.uniforms,patchMap:s.__csm.patchMap,cacheKey:s.__csm.cacheKey})}}module.exports=V;
