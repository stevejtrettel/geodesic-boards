...
export default class Board extends Vignette {
    ...
    constructor() {
        ...
        this.tv0 = new TangentVector(new Vector2(6.,this.ini.p0),new Vector2(-Math.cos(this.ini.a0),Math.sin(this.ini.a0)))
        this.geo0 = new Geodesic(this.bh,this.tv0,0.05,geoMat);

        this.tv1 = new TangentVector(new Vector2(6.,this.ini.p1),new Vector2(-Math.cos(this.ini.a1),Math.sin(this.ini.a1)))
        this.geo1 = new Geodesic(this.bh,this.tv1,0.05,geoMat);

        this.tv2 = new TangentVector(new Vector2(6.,this.ini.p2),new Vector2(-Math.cos(this.ini.a2),Math.sin(this.ini.a2)))
        this.geo2 = new Geodesic(this.bh,this.tv2,0.05,geoMat);

        this.tv3 = new TangentVector(new Vector2(6.,this.ini.p3),new Vector2(-Math.cos(this.ini.a3),Math.sin(this.ini.a3)))
        this.geo3 = new Geodesic(this.bh,this.tv3,0.05,geoMat);

        this.tv4 = new TangentVector(new Vector2(6.,this.ini.p4),new Vector2(-Math.cos(this.ini.a4),Math.sin(this.ini.a4)))
